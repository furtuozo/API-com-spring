...
public class PersonController {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<PersonResponseDTO> update(@RequestBody PersonResponseDTO personRequestDTO, @PathVariable(name = "id") Long id){
        PersonRequestDTO personDTO = null;
